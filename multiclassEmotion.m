% multiclass emotion
% NOTE: run dataForEmotion.m first before running this code to get the
% reformatted target data
...
for a = 1:part
    ...
    performance(a) = perform(net,ttest{a,1},output);
